...
BiocManager::install("pd.mogene.2.1.st", force = TRUE)
...
dir.create("D://project/") #Create main folder
dir.create("D://project/microarray-p1") ##project folder
dir.create("D://project/microarray-p1/data") ## Input data
dir.create("D://project/microarray-p1/results")####Results
dir.create("D://project/microarray-p1/figures")#####Figures
setwd("D://project/microarray-p1") # Setting directory path
